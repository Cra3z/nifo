...
vec4 get_frag_color() {
    ...
    vec4 specular = material.specular_intensity * material.specular_color * texture(material.specular, gs_out.uv) * phong_spec(normal, light.direction, eye, gs_out.position, material.shininess) * light.specular_color;
